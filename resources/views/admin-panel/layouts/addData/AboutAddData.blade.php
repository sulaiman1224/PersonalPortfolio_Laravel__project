...
@section('Content')
    ...
    <div class="container" id="Home">
        ...
        <div class="recentCustomers">
            ...
            <div>
                <form id="dataForm" action="{{ url('StoreAboutData') }}" method="POST">
                    @csrf
                    @if ($errors->any())
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-12">
                            ...
                            <textarea id="profession_description" class="form-control" placeholder="profession description"
                                name="profession_description"></textarea>
                            <span class="FormAuthentication">
                        ...
                        <div class="col-md-12">
                            ...
                            <textarea id="journey" class="form-control" placeholder="Enter  journey" name="journey"></textarea>
                            <span class="FormAuthentication">
                                @error('journey')
                                    {{ $message }}
                                @enderror
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-12">
                            ...
                            <textarea id="skill_1_description" class="form-control" placeholder="what I do in Front-End Development"
                                name="skill_1_description"></textarea>
                            <span class="FormAuthentication">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-12">
                            ...
                            <textarea id="skill_2_description" class="form-control" placeholder="what I do in back-End Development"
                                name="skill_2_description"></textarea>
                            <span class="FormAuthentication">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-12">
                            ...
                            <textarea id="skill_3_description" class="form-control" placeholder="what I do in Responsive Design"
                                name="skill_3_description"></textarea>
                            <span class="FormAuthentication">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-12">
                            ...
                            <textarea id="skill_4_description" class="form-control" placeholder="what I do in Performance Optimization"
                                name="skill_4_description"></textarea>
                            <span class="FormAuthentication">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-12">
                            ...
                            <textarea id="skill_5_description" class="form-control" placeholder="what I do in SEO Best Practices"
                                name="skill_5_description"></textarea>
                            <span class="FormAuthentication">
                    ...
                    <div class="row mb-3">
                        <div class="col-md-12">
                            ...
                            <textarea id="my_approach" class="form-control" placeholder="write description" name="my_approach"></textarea>
                            <span class="FormAuthentication">
                                @error('my_approach')
                                    {{ $message }}
                                @enderror
                        ...
                        <div class="col-md-12">
                            ...
                            <textarea id="lets_connect" class="form-control" placeholder="write description" name="lets_connect"></textarea>
                            <span class="FormAuthentication">
                                @error('lets_connect')
                                    {{ $message }}
                                @enderror
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-3">
                            ...
                            <input name="email" class="form-control" id="email" type="email"
                                placeholder="sk12243648gmail.com" />
                            <span class="FormAuthentication">
                                @error('email')
                                    {{ $message }}
                                @enderror
                    ...
                    <div class="row mb-3">
                        <div class="col-md-4">
                            ...
                            <input name="first_language_name" class="form-control" id="first_language_name"
                                type="text" placeholder="first skill name eg js" />
                            <span class="FormAuthentication">
                        ...
                        <div class="col-md-4">
                            ...
                            <input name="first_language_pct" class="form-control" id="first_language_pct" type="text"
                                placeholder="First skill percentage 80%" />
                            <span class="FormAuthentication">
                        ...
                        <div class="col-md-4">
                            ...
                            <input name="second_language_name" class="form-control" id="second_language_name"
                                type="text" placeholder="second skill name eg js" />
                            <span class="FormAuthentication">
                        ...
                        <div class="col-md-4">
                            ...
                            <input name="second_language_pct" class="form-control" id="second_language_pct"
                                type="text" placeholder="second skill percentage eg 80%" />
                            <span class="FormAuthentication">
                        ...
                        <div class="col-md-4">
                            ...
                            <input name="third_language_name" class="form-control" id="third_language_name"
                                type="text" placeholder="Third skill name eg js" />
                            <span class="FormAuthentication">
                        ...
                        <div class="col-md-4">
                            ...
                            <input name="third_language_pct" class="form-control" id="third_language_pct" type="text"
                                placeholder="Third skill percentage eg 80%" />
                            <span class="FormAuthentication">
                        ...
                        <div class="col-md-4">
                            ...
                            <input name="fourth_language_name" class="form-control" id="fourth_language_name"
                                type="text" placeholder="fourt skill name eg js" />
                            <span class="FormAuthentication">
                        ...
                        <div class="col-md-4">
                            ...
                            <input name="fourth_language_pct" class="form-control" id="fourth_language_pct"
                                type="text" placeholder="fourt skill percentage eg 80%" />
                            <span class="FormAuthentication">
                    ...
                    <div class="row mb-3">
                        <div class="col-md-12">
                            ...
                            <input name="first_education_title" class="form-control" id="first_education_title"
                                type="text" placeholder="Educational Background" />
                            <span class="FormAuthentication">
                        ...
                        <div class="col-md-12">
                            ...
                            <textarea id="first_education_description" class="form-control" placeholder=" i am ...."
                                name="first_education_description"></textarea>
                            <span class="FormAuthentication">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-12">
                            ...
                            <textarea id="second_education_description" class="form-control" placeholder=" i am ...."
                                name="second_education_description"></textarea>
                            <span class="FormAuthentication">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-12">
                            ...
                            <textarea id="third_education_description" class="form-control" placeholder=" i am ...."
                                name="third_education_description"></textarea>
                            <span class="FormAuthentication">
                    ...
                    <div class="mt-4 mb-0">
                        <div class="d-grid">
                            <input type="submit" class="btn btn-primary btn-block" value="Add Data About"
                                name="submit">
                        </div>
                    </div>
                </form>
    ...
    document.getElementById('dataForm').addEventListener('submit', function (e) {
        ...
        .then(data => {
            Swal.fire({
                ...
                window.location.href = '/Admin/About/AddData'; // Redirect on success
            });
        })
        .catch(err => {
